...
function ChangeLanguageWS()
{
    ...
    {
        t.value="EN";
        document.getElementById("wsInfo").innerHTML = '<span style=\"font-weight:normal\"> <b>What\'s the game about?</b><br></br>Wizard\'s Struggle is a challenging game that is easy to learn, but hard to master!The game is 2 - ∞ hours long, the average time for the playtesters to finish was 4h. If you fall you will lose most of your progress. Can you save the princess? <br></br><b>Game Jam</b><br></br>This game was made for the <a href="https://itch.io/jam/game-off-2022" target="_blank" rel="noopener noreferrer"><i>Game Off 2022</i></a>. I had a month to make a game based off a theme. The theme of the Game Off 2022 is "Cliché". My cliché is "At the end of the day, the hero saves the girl".<br></br>While making this project I learned how to design 2D maps (I used Illustrator) and how to use audio in Unity. (SFX and music)<br></br>Wizard\'s Struggle took me a month to make in Unity (around 10 hours per week) and you can play it on Windows. <br></br>Click <a href="https://itskevin183.itch.io/wizards-struggle" target="_blank" rel="noopener noreferrer"><i>here</i></a> to go to the itch.io page of Wizard\'s Struggle.<br></br>Click <a href="https://github.com/KevinPladdet/Wizards-Struggle" target="_blank" rel="noopener noreferrer"><i>here</i></a> to go to the GitHub page of Wizard\'s Struggle. </span><br></br>Click <a href="/gamebuilds/WebGL_WizardsStruggle/WizardsStruggleWeb.html"><i>here</i></a> to try Wizard\'s Struggle out for yourself. </span>';
    }
    else if(t.value=="EN")
    {
        t.value="NL";
        document.getElementById("wsInfo").innerHTML = '<span style=\"font-weight:normal\"> <b>Waar gaat het spel over?</b><br></br>Wizard\'s Struggle is een uitdagend spel dat makkelijk te leren is, maar moeilijk te beheersen! Het spel duurt 2 - ∞ uur, de gemiddelde tijd voor de playtesters om het uit te spelen was 4 uur. Als je valt verlies je het grootste deel van je voortgang. Kun jij de prinses redden?<br></br><b>Game Jam</b><br></br>Dit spel is gemaakt voor de <a href="https://itch.io/jam/game-off-2022" target="_blank" rel="noopener noreferrer"><i>Game Off 2022</i></a>Ik had een maand om een spel te maken gebaseerd op een thema. Het thema van de Game Off 2022 is "Cliché". Mijn cliché is "Aan het einde van de dag redt de held het meisje".<br></br>Tijdens het maken van dit project heb ik geleerd hoe je 2D maps ontwerpt (ik gebruikte Illustrator) en hoe je audio gebruikt in Unity. (SFX en muziek)<br></br>Wizard\'s Struggle kostte me een maand om te maken in Unity (ongeveer 10 uur per week) en je kunt het spelen op Windows.<br></br>Klik <a href="https://itskevin183.itch.io/wizards-struggle" target="_blank" rel="noopener noreferrer"><i>hier</i></a> om naar de itch.io pagina van Wizard\'s Struggle te gaan.<br></br>Klik <a href="https://github.com/KevinPladdet/Wizards-Struggle" target="_blank" rel="noopener noreferrer"><i>hier</i></a> om naar de GitHub pagina van Wizard\'s Struggle te gaan.</span><br></br>Klik <a href="/gamebuilds/WebGL_WizardsStruggle/WizardsStruggleWeb.html"><i>hier</i></a> om Wizard\'s Struggle zelf uit te proberen.</span>';
    }
}
...
function ChangeLanguageConstructionMadness()
{
    ...
    if(t.value=="NL")
    {
        t.value="EN";document.getElementById("cmInfo").innerHTML = '<span style=\"font-weight:normal\"> <b>What\'s the game about?</b><br></br>Construction Madness is a 2D game where you climb a construction site. At the top of the construction site is a worker who is trying to stop you by throwing his tools and paint cans down. Can you get to the top and defeat the worker?<br></br><b>Team Project</b><br></br>I made this game in a group with 4 art designers and 1 other programmer. The game took us 2 months to make and was made with Unity. I made the Main Menu/Settings Menu/Pause Menu, the Hammer system, the Animations and the Level Design.<br></br>While making this project I learned how to work together in the same project using GitHub and how to add animations to characters and objects.<br></br>Click <a href="https://github.com/StanNooijen/Construction-madness" target="_blank" rel="noopener noreferrer"><i>here</i></a> to go to the GitHub page of Construction Madness. </span><br></br>Click <a href="/gamebuilds/WebGL_ConstructionMadness/ConstructionMadnessWeb.html"><i>here</i></a> to try Construction Madness out for yourself. </span><br></br><i>This does not work on phones/tablets.</i>';
    }
    else if(t.value=="EN")
    {
        t.value="NL";
