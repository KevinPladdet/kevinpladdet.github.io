...
function ChangeLanguageWS()
{
    ...
    {
        t.value="EN";
        document.getElementById("wsInfo").innerHTML = '<span style=\"font-weight:normal\"> <b>What\'s the game about?</b><br></br> Wizard’s Struggle is a challenging game that is easy to learn, but hard to master! The game is 2 - ∞ hours long, the average time for the playtesters to finish was 4h. If you fall you will lose most of your progress. Can you save the princess? <br></br><b>Game Jam</b><br></br>This game was made for the <a href="https://itch.io/jam/game-off-2022" target="_blank" rel="noopener noreferrer"><i>Game Off 2022</i></a>. I had a month to make a game based off a theme. The theme of the Game Off 2022 is "Cliché". I had a month to make a game based on that theme. My cliché is "At the end of the day, the hero saves the girl".<br></br>While making this project I learned how to design 2D maps (I used Illustrator) and how to use audio in Unity. (SFX and music)<br></br>Wizard’s Struggle took me a month to make in Unity (around 10 hours per week) and you can play it on Windows. <br></br>Click <a href="https://itskevin183.itch.io/wizards-struggle" target="_blank" rel="noopener noreferrer"><i>here</i></a> to try Wizard’s Struggle out for yourself.';
    }
    else if(t.value=="EN")
    {
        t.value="NL";
        document.getElementById("wsInfo").innerHTML = '<span style=\"font-weight:normal\"> <b>Waar gaat het spel over?</b><br></br> Wizard’s Struggle is een uitdagend spel dat makkelijk te leren is, maar moeilijk te beheersen!<br></br>Het spel is 2 - ∞ uur lang, de gemiddelde tijd voor de playtesters om het uit te spelen was 4 uur. Als je valt verlies je een groot deel van je vooruitgang. Kun jij de prinses redden?<br></br><b>Game Jam</b><br></br>Dit spel is gemaakt voor de <a href="https://itch.io/jam/game-off-2022" target="_blank" rel="noopener noreferrer"><i>Game Off 2022</i></a>. Ik had een maand om een spel te maken gebaseerd op een thema. Het thema van de Game Off 2022 is "Cliché". Ik had een maand om een spel te maken gebaseerd op dat thema. Mijn cliché is "Aan het einde van de dag, redt de held de prinses".<br></br>Tijdens het maken van dit project heb ik geleerd hoe je 2D maps ontwerpt (ik gebruikte Illustrator) en hoe je audio gebruikt in Unity. (SFX en muziek)<br></br>Wizard’s Struggle duurde me een maand om te maken met Unity (ongeveer 10 uur per week) en je kunt het spelen op Windows.<br></br>Klik <a href="https://itskevin183.itch.io/wizards-struggle" target="_blank" rel="noopener noreferrer"><i>hier</i></a> om Wizard’s Struggle zelf uit te proberen.';
    }
}
