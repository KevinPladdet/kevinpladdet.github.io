...
function ChangeLanguageRedo()
{
    ...
    {
        t.value="EN";
        document.getElementById("redoInfo").innerHTML = '<span style=\"font-weight:normal\"> <b>What\'s the game about?</b><br></br>Redo is a platformer game about collecting abilities. <br> Each time you beat a level, you gain a new ability. The end of a level is a new beginning and with each ability a new path opens up. The goal is to unlock every ability and use them to beat the final level. Can you beat Redo?<br></br><b>Why did I make this project?</b><br></br> During the <a href="https://itch.io/jam/brackeys-9" target="_blank" rel="noopener noreferrer"><i>Brackeys game jam 2023.1</i></a> the theme was "An end is a new beginning". I had joined the game jam at that time and made <a href="https://pastebin.com/9tAgUgz0" target="_blank" rel="noopener noreferrer"><i>a game idea</i></a> for it. I never finished the game and only spent a couple days on it.<br></br>During my internship I started a new project, with the same game idea. This project is called Redo and I made a <a href="https://jmp.sh/663bn7hb" target="_blank" rel="noopener noreferrer"><i>game design document</i></a> for it which contains everything.<br></br><b>What did I learn?</b><br></br>I got better at making game design documents and working with the agile workway. Because I worked in sprints, I managed to complete a level every month. <br> This includes playtesting and planning ahead.      <br></br>During the development of Redo, I got better at game design. When I made the fake floor puzzle in the first level, I didn\'t like how it turned out to be. I completely remade the puzzle and even added a "tutorial" (if you fall, a text explanation appears). If you are struggling with this puzzle, the game helps you too. After failing the puzzle 5 times, the correct tiles will turn green once stepped on.<br></br><b>Other Information</b><br></br>Redo took me 3 months to make in Unity (around 40 hours per week) and you can play it on Windows. <br></br>Click <a href="https://jmp.sh/663bn7hb" target="_blank" rel="noopener noreferrer"><i>here</i></a> to view the game design document for Redo.</span><br></br>Click <a href="/gamebuilds/WebGL_Redo/RedoWeb.html"><i>here</i></a> to try Redo out for yourself. </span><br></br><i>This does not work on phones/tablets.</i>';
    }
    else if(t.value=="EN")
    {
        t.value="NL";
...
function ChangeLanguageMultiplayerGame()
{
    ...
    {
        t.value="EN";
        document.getElementById("multiplayerGameInfo").innerHTML = '<span style=\"font-weight:normal\"> <b>What\'s the project about?</b><br></br>MultiplayerGame is a project I made to learn how multiplayer works. The goal of this project is to focus on the multiplayer aspect instead of the game, which means I want to make the multiplayer as fine-tuned as possible.<br></br>I started with making the multiplayer work and after that I added more functions. Some examples of these functions are the friends menu, a way to invite friends, multiple lobby types, a color chooser for your player and a ready up system.<br></br><b>Why did I make this project?</b><br></br>I have played a lot of multiplayer games in my life and I have always wondered how they work. Playing a multiplayer game with friends is super fun, so I wanted to try and make one myself. <br></br>At school I had a project where I could learn whatever I wanted as long as it is code related. I knew this was my moment to try out multiplayer. Even if I were to fail I would still gain experience from it.<br></br>At first I wanted to make a full game including multiplayer, but I quickly realised how much effort and time it takes to create a fully working multiplayer system. I then decided I would only focus on the multiplayer aspect and I tried to make it as polished as I could.<br></br><b>How does it work?</b><br></br>I did not know where to start when I began this project, so I did some research on how multiplayer works.<br></br>There is an asset pack on Unity called <a href="https://assetstore.unity.com/packages/tools/network/mirror-129321"target="_blank" rel="noopener noreferrer"><i>Mirror</i></a>, which many people use to set up multiplayer. Another thing you need for multiplayer is <a href="https://github.com/Chykary/FizzySteamworks"target="_blank" rel="noopener noreferrer"><i>Steamworks</i></a>, which is used to communicate with the Steamworks API. Once you have these 2 asset packs installed the fun begins.<br></br>With Steamworks and Mirror you can make it so that you can host servers on a Steam app id. On Steam there is a game called Spacewar, which uses Steam app id 480. Spacewar is a public Steam app id, so anyone can use those servers.<br></br>During development you can use Spacewar\'s id. Once you have published your game on Steam though, you can use your game\'s unique id instead of Spacewar\'s network.<br></br><b>What did I learn?</b><br></br><i>Multiplayer in general</i><br></br>I did not know anything about how multiplayer worked when I started this project.<br></br>During the development of this project I learned how Mirror and Steamworks work. Ofcourse I can not say I am an expert at it, because I am not. I have used it enough to understand how it works, but I still make a lot of mistakes.<br></br>I\'d say the function I am most proud of is the friends menu. It looks awesome and I love the online indicator as well.<br>I had made the user prefab for the lobby menu, so I reused that and changed the ready up part with an invite button. For the online indicator I used a Steamworks function to check if they are online.<br></br><i>Testing with Sandboxie-Plus</i><br></br>At the beginning of my project the only way to test the game was to get someone around me to install it and to open it. They also needed their own steam account, since the game uses Spacewar to host / join lobbies.<br></br>I needed to find a workaround for this and after a lot of research I found out about <a href="https://sandboxie-plus.com/"target="_blank" rel="noopener noreferrer"><i>Sandboxie-Plus</i></a>. With this program you can open any application again without having to permanently install it. After you\'re done with the application, Sandboxie will delete all of the files it used.<br></br>So by using Sandboxie-Plus I managed to have 2 applications of Steam open at the same time, so I could test the multiplayer with my main account and an alt account. This worked perfectly and I never needed another computer again to test out the game.<br></br><b>What\'s next?</b><br></br> At this current state the multiplayer is done and there are many functions with it. Anyone can host a game or join a game through the lobbies browser or with an invite. <br></br>There are still a couple bugs that need to be fixed, but besides that the project is ready to be turned into a game.<br></br>I don\'t know when I will pick this project up again, but I would probably turn it into a shooter. The color chooser could be turned into a class selector (shotgun, sniper, etc) and since I now know how multiplayer works, I could start working on that.<br></br><b>Other Information</b><br></br>MultiplayerGame took me 3 months to make in Unity and I worked around 12 hours per week on it.<br></br>Before the game looked like it does now, the project had the default Unity UI buttons / text / etc.<br>The project then got a complete makeover and I changed the layout for everything. The text got a nice font and I tried to work with a color scheme for the UI.<br></br>I love how it turned out in the end and I\'m really proud of this project in general.<br></br><i>The GitHub repository will not be shared, because it is a fully working multiplayer project that could otherwise be used by others for their own gains.</i>';
    }
    else if(t.value=="EN")
    {
        t.value="NL";
        document.getElementById("multiplayerGameInfo").innerHTML = '<span style=\"font-weight:normal\"> <b>Waar gaat het project over?</b><br></br>MultiplayerGame is een project dat ik heb gemaakt om te leren hoe multiplayer werkt. Het doel van dit project is om te focussen op het multiplayer aspect in plaats van het spel, wat betekent dat ik multiplayer zo goed mogelijk wil hebben.<br></br>Ik ben begonnen met multiplayer werkend te maken en daarna heb ik beetje bij beetje meer functies toegevoegd. Voorbeelden hiervan zijn bijvoorbeeld het friends menu, een manier om friends te inviten, meerdere lobby types, een kleurkiezer voor je speler en een ready up systeem.<br></br><b>Waarom heb ik dit project gemaakt?</b><br></br>Ik heb veel multiplayer games gespeeld in mijn leven en ik heb me altijd afgevraagd hoe ze werken. Een multiplayer game spelen met vrienden is superleuk, dus ik wilde proberen er zelf een te maken. <br></br>Op school had ik een project waarbij ik mocht leren wat ik maar wilde, zolang het maar met code te maken had. Ik wist dat dit mijn moment was om multiplayer uit te proberen. Zelfs als ik zou falen, zou ik er ervaring mee opdoen.<br></br>In eerste instantie wilde ik een volledig spel maken inclusief multiplayer, maar ik realiseerde me al snel hoeveel moeite en tijd het kost om een volledig werkend multiplayersysteem te maken. Ik besloot toen dat ik me alleen op het multiplayer-aspect zou richten en probeerde het zo goed mogelijk te maken.<br></br><b>Hoe werkt het?</b><br></br>Ik wist niet waar ik moest beginnen toen ik aan dit project begon, dus ik heb wat onderzoek gedaan naar hoe multiplayer werkt.<br></br>Er is een asset pack op Unity genaamd <a href="https://assetstore.unity.com/packages/tools/network/mirror-129321"target="_blank" rel="noopener noreferrer"><i>Mirror</i></a>, dat veel mensen gebruiken om multiplayer op te zetten. Iets anders dat je nodig hebt voor multiplayer is <a href="https://github.com/Chykary/FizzySteamworks"target="_blank" rel="noopener noreferrer"><i>Steamworks</i></a>, dat wordt gebruikt om te communiceren met de Steamworks API. Zodra je deze 2 asset packs hebt geïnstalleerd, kan de lol beginnen.<br></br>Met Steamworks en Mirror kun je servers hosten op een Steam app id. Op Steam is er een spel genaamd Spacewar, dat Steam app id 480 gebruikt. Spacewar is een openbare Steam app id, dus iedereen kan die servers gebruiken.<br></br>Tijdens development kun je Spacewar\'s id gebruiken. Maar als je je spel eenmaal op Steam hebt gepubliceerd, kun je het unieke id van je spel gebruiken in plaats van het netwerk van Spacewar.<br></br><b>Wat heb ik geleerd?</b><br></br><i>Multiplayer in het algemeen</i><br></br>Ik wist niets over hoe multiplayer werkte toen ik aan dit project begon.<br></br>Tijdens de ontwikkeling van dit project heb ik geleerd hoe Mirror en Steamworks werken. Natuurlijk kan ik niet zeggen dat ik er een expert in ben, want dat ben ik niet. Ik heb het genoeg gebruikt om te begrijpen hoe het werkt, maar ik maak nog steeds veel fouten.<br></br>Ik zou zeggen dat de functie waar ik het meest trots op ben het friends menu is. Het ziet er geweldig uit en ik hou van de online indicator. Ik had de user prefab voor het lobby menu al eerder gemaakt, dus die heb ik hergebruikt en het ready up gedeelte veranderd in een invite knop. Voor de online indicator heb ik een Steamworks functie gebruikt om te controleren of ze online zijn.<br></br><i>Testen met Sandboxie-Plus</i><br></br>Aan het begin van mijn project was de enige manier om het spel te testen om iemand in de buurt het te laten installeren en openen. Ze hadden ook hun eigen steam account nodig, omdat de game Spacewar gebruikt om lobbies te hosten / joinen.<br></br>Ik moest hier een oplossing voor vinden en na veel onderzoek kwam ik uit bij <a href="https://sandboxie-plus.com/"target="_blank" rel="noopener noreferrer"><i>Sandboxie-Plus</i></a>. Met dit programma kun je elke applicatie opnieuw openen zonder deze permanent te installeren. Nadat je klaar bent met de applicatie, verwijdert Sandboxie alle bestanden die het heeft gebruikt.<br></br>Dus door Sandboxie-Plus te gebruiken lukte het me om 2 applicaties van Steam tegelijkertijd open te hebben staan, zodat ik de multiplayer kon testen met mijn account en een alt account. Dit werkte perfect en ik heb nooit meer een andere computer nodig gehad om het spel te testen.<br></br><b>Wat is de volgende stap?</b><br></br> Op dit moment is multiplayer klaar en er zijn veel functies erbij. Iedereen kan een spel hosten of meedoen met een spel via de lobbybrowser of met een invite. <br></br>Er zijn nog een paar bugs die opgelost moeten worden, maar naast dat is het project klaar om in een spel te veranderen<br></br>Ik weet niet wanneer ik dit project weer oppak, maar ik zou er waarschijnlijk een shooter van maken. De kleurkiezer zou ik kunnen veranderen in een class selector (shotgun, sniper, etc) en aangezien ik nu weet hoe multiplayer werkt, zou ik daar aan kunnen beginnen.<br></br><b>Overige Informatie</b><br></br>MultiplayerGame kostte me 3 maanden om te maken in Unity en ik heb er ongeveer 12 uur per week aan gewerkt.<br></br>Voordat het spel eruit zag zoals het er nu uitziet, had het project de standaard Unity UI knoppen / tekst / etc.<br>Het project kreeg toen een complete make-over en ik veranderde de lay-out voor alles. De tekst kreeg een mooi lettertype en ik probeerde te werken met een kleurenschema voor de UI.<br></br>Ik vind het geweldig hoe het project uiteindelijk is geworden en ik ben echt trots op dit project in het algemeen.<br></br><i>De GitHub repository wordt niet gedeeld, omdat het een volledig werkend multiplayer project is dat anders door anderen gebruikt zou kunnen worden voor hun eigen profijt.</i>';
    }
}